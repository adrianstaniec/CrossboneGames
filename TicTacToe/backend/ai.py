...
win_in_1 = lambda matrix, player: __add_third_in_line(matrix,
                                                      player,
                                                      __win)

defend_in_1 = lambda matrix, player: __add_third_in_line(matrix,
                                                         player,
                                                         __defend)
...
__algorithms = {0: [first_from_left],
                ...
                6: [win_in_1, defend_in_1, take_center, take_corner, take_side,
                    random_pick]}
